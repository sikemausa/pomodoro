...
/***/ function(module, exports, __webpack_require__) {
	...
	function playAudio(timer) {
	  if (timer.remainingTime < 21000 && timer.remainingTime > 20000) {
	    audio.play();
	  }
	  if (timer.remainingTime < 16000 && timer.remainingTime > 15000) {
	    audio.play();
	  }
	  if (timer.remainingTime < 11000 && timer.remainingTime > 10000) {
	    audio.play();
	  }
	  if (timer.remainingTime < 6000 && timer.remainingTime > 5000) {
	    audio.play();
	  }
	  if (timer.remainingTime < 1000 && timer.remainingTime > 0) {
	    audio.play();
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(!locales[name]&&typeof module!=='undefined'&&module&&module.exports){try{oldLocale=globalLocale._abbr;__webpack_require__(10)("./"+name);// because defineLocale currently also sets the global locale, we
...
/***/ function(module, exports, __webpack_require__) {
	...
	;(function (global, factory) {
	     true ? factory(__webpack_require__(8)) : typeof define === 'function' && define.amd ? define(['../moment'], factory) : factory(global.moment);
